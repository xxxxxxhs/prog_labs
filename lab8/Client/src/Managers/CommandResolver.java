...
public class CommandResolver {
    ...
    public static LinkedList<Request> executeScript(String fileName, String username, String hashPassword) {
        ...
        System.out.println("execution: " + absolutePath);
        System.out.print("now in progress: ");
        for (String scr : scriptsInProgress) {
        ...
        try {
            ...
            while (lineIterator.hasNext()) {
                ...
                if ("add".equals(command) || "update".equals(command)) {
                    ...
                    if (!scriptsInProgress.contains(argument)) {
    ...
    public static Request resolve(String[] args, Movie movie, String username, String hashPassword) {
