...
public class Commander {
    ...
    public Response executeCommand(Request request) {
        ...
        if (foundCommand != null) {
            ...
            if (!foundCommand.getName().equals("history") && !foundCommand.getName().equals("show"))
                collectionManager.addToHistory(foundCommand.getName());
            System.out.println("execution " + foundCommand.getName() + " " + (request.getArgument() != null ? request.getArgument() : ""));
            Response response = foundCommand.execute(request.getMovie(), request.getArgument(), request.getUsername());
            System.out.println(response == null ? "nullll" : response.getAnswer());
